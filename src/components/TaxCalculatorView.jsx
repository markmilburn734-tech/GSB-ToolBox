...
export default function TaxCalculatorView({ symbol = "£", currency = "GBP", pricesData = {} }) {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8 relative animate-in fade-in">
            ...
            <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        <h1 className="font-serif text-2xl font-bold text-gray-900 tracking-tight">CGT Estimator</h1>
                ...
                <div className="bg-white/75 backdrop-blur-sm p-5 rounded-xl shadow-sm border border-gray-200 flex flex-col min-w-[200px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-brand p-6 rounded-2xl shadow-lg border border-brand2 flex flex-col justify-between">
                    <div className="flex items-center justify-between">
                        ...
                        >
                            <div className={`absolute top-1 bg-white/75 backdrop-blur-sm w-4 h-4 rounded-full transition-transform duration-300 shadow-sm ${isJoint ? 'left-7' : 'left-1'}`} />
                        </button>
                    </div>
            ...
            {/* Middle Control Bar */}
            <div className="bg-white/75 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                    ...
                    <div className="relative flex-1 min-w-[160px]">
                        ...
                        {addMenuOpen && (
                            <>
                                ...
                                <div className="absolute right-0 mt-2 w-72 bg-white/75 backdrop-blur-sm border border-gray-200 rounded-xl shadow-xl z-20 overflow-hidden animate-in zoom-in-95 duration-100 origin-top-right">
            ...
            <div className="bg-white/75 backdrop-blur-sm rounded-2xl shadow-sm border border-brand overflow-hidden">
