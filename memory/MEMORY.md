...
- [CGT sell-down solver](cgt-selldown-solver.md) — exact LP-backed optimiser with per-holding max-to-sell sliders; why the old solver was wrong despite "passing"
